...
try {
    ...
    $stmt = $pdo->prepare("INSERT INTO orders (user_id, order_number, total_amount, coupon_code, discount_amount, status, delivery_otp, shipping_address, payment_method, payment_reference) VALUES (?, ?, ?, NULL, 0, 'processing', '123456', '12 Test St, Accra', 'card', ?)");
    $stmt->execute([5, $ref, 175.00, $ref]);
