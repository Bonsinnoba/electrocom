...
export default function GlobalSettings() {
  const [settings, setSettings] = useState(() => {
    try { return { ...DEFAULTS, ...JSON.parse(localStorage.getItem('super_settings') || '{}') }; }
  ...
  const save = async () => {
    setSaving(true);
    localStorage.setItem('super_settings', JSON.stringify(settings));
    // Try real API
    fetch('http://localhost/EssentialsHub-project/api/super_settings.php', {
      method: 'POST',
