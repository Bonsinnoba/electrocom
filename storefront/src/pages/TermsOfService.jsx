      ...
      <div className="glass" style={{ padding: '40px', borderRadius: '32px', marginBottom: '40px' }}>
        <section style={{ marginBottom: '40px' }}>
          ...
          <p style={{ lineHeight: '1.8', color: 'var(--text-main)', opacity: 0.9 }}>
            By accessing or using EssentialsHub, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing this site.
          </p>
        </section>
        ...
        <section style={{ marginBottom: '40px' }}>
          ...
          <p style={{ lineHeight: '1.8', color: 'var(--text-main)', opacity: 0.9 }}>
            Permission is granted to temporarily download one copy of the materials (information or software) on EssentialsHub's website for personal, non-commercial transitory viewing only.
          </p>
        </section>
        ...
        <section style={{ marginBottom: '40px' }}>
          ...
          <p style={{ lineHeight: '1.8', color: 'var(--text-main)', opacity: 0.9 }}>
            The materials on EssentialsHub's website are provided on an 'as is' basis. EssentialsHub makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.
          </p>
        </section>
